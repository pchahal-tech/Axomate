...
namespace Axomate.Infrastructure.Migrations
{
    ...
    [Migration("20250823063833_Vehicle_PartialUniqueIndexes")]
    partial class Vehicle_PartialUniqueIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Axomate.Domain.Models.Vehicle", b =>
                {
                    ...
                    b.HasIndex("LicensePlate")
                        .IsUnique()
                        .HasFilter("LicensePlate IS NOT NULL AND length(trim(LicensePlate)) > 0");

                    b.HasIndex("VIN")
                        .IsUnique()
                        .HasFilter("VIN IS NOT NULL AND length(trim(VIN)) > 0");
